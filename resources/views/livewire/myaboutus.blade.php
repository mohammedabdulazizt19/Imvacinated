        ...
        <div class="container">
            ...
            <div class="row align-items-center section-overlay mb-30">
                <div class="offset-xl-1 col-xxl-5 col-xl-6 col-lg-6 col-md-9">
                    <div class="about-caption about-caption1">
                        <div class="section-tittle section-tittle3 mb-25">
                            <h2>Boodle fight round #2 is up!</h2>
                            <p>Call now and reserve your seat.</p>
                            <p>Tel# 0503 881 180</p>
                            <p>Sulaimaniyah area, Riyadh, Saudi Arabia</p>
                            <p>Thursdays : Sound Fuzion Band (KTV)</p>
                            <p>Fridays : Live Band</p>
                            <p>Saturdays : Acoustic Sessions/ Live Band 6:00 PM to 10:30 PM</p>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-8">
                    ...
                    <div class="about-img about-img1">
                        <img src="{{ asset('themes/cakeshop2/assets/img/boodles/boodles_3.jpeg')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
