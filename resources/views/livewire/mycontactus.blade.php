    ...
    <section class="contact-section">
        <div class="container">
            <div class="d-none d-sm-block mb-5 pb-4">
                <div id="map" style="height: 480px; position: relative; overflow: hidden;">
                    <div
                        ...
                        <div class="gm-style"
                            ...
                            <div tabindex="0"
                                style="position:absolute;z-index:0;left:0;top:0;height:100%;width:100%;padding:0;border-width:0;margin:0;cursor:url(../../mapfiles/openhand_8_8.cur) , default;touch-action:pan-x pan-y">
                                <div
                            ...
                            <div
                                ...
                                <a target="_blank" rel="noopener"
                                    ...
                                    <div style="width: 66px; height: 26px; cursor: pointer;"><img alt=""
                                            src="../../mapfiles/api-3/images/google_white5.png" draggable="false"
                    ...
                    <div
                        ...
                        <div><img alt="" src="../../mapfiles/api-3/images/google_gray.svg" draggable="false"
                ...
                <script src="../../maps/api/js?key=AIzaSyDpfS1oRGreGSBU5HHjMmQ3o5NLw7VdJ6I&amp;callback=initMap">
                </script>
            </div>
            <div class="row">
                <div class="col-12">
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3>1st Floor, Aljazeera Shopping Center, Musa Ibn Nussair St., Al Sulaimaniah Riyadh,</h3>
                            <p>Saudi Arabia 12241</p>
                        </div>
                    </div>
                    <div class="media contact-info">
                        <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                        <div class="media-body">
                            <h3>+966 50 388 1180</h3>
                            <p>Mon to Fri 10:00 AM to 11:00 PM</p>
                        </div>
                    </div>
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                    data-cfemail="66151316160914122605090a09140a0f044805090b">[email&#160;protected]</a>
                            </h3>
